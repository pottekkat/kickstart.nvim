...
--  Removing the below keymaps to instead use tmux keymaps
...
--    :Lazy update
--
-- NOTE: Install plugins using lazy.nvim.
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      icons = {
        -- set icon mappings to true and keys if there is a Nerd Font
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      -- Also see: `:help lsp-vs-treesitter`
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          --  Useful when it is not sure what type a variable is and you want to see
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- For traditional completion keymaps, uncomment the following lines
          ...
          -- <c-l> will move the cursor to the right of each of the expansion locations.
          -- <c-h> is similar, except moving the cursor backwards.
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --  Learn more: https://github.com/echasnovski/mini.nvim
    end,
  },
  { -- Highlight, edit, and navigate code
    ...
    -- with nvim-treesitter. Explore a few and see what interests you:
    --
  ...
  -- Example plugins included in the Kickstart repository:
